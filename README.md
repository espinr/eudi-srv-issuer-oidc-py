...
# EUDI-Compatible Sports Wallet - Issuer Authorization Server
...
* ISSUANCE SERVICE:
  ...
  * OIDC server (this repo): https://github.com/espinr/eudi-srv-issuer-oidc-py
...
## About the Issuer Authorization Server
